...
extern "C" {
	...
	{
		g_ClothSim.Init(positions,triangles, num_positions,num_triangles, delta_time, algorithm_type,scenario, solver_iterations, static_particles, num_static_particles, substeps, sphere_centre,sphere_radius);
	}
