...
As mentioned in the physics section, mass-spring systems are a popular approach to cloth simulations. They represent a cloth as a grid of particles that can exert forces on each other. The way they exert forces are through springs. As mentioned in the history of cloth simulation section, the first example of this system was introduced by Provot \cite{provot1995deformation}.\\
