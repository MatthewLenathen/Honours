...
Unity is typically used for game development but it is also a very useful tool for building interactive simulations. 
...
\subsection{Start/initialisation}
...
- maybe a section on experiment setup, parameters?, mostly saved for results section
